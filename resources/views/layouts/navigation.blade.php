                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
                                <div><a href="https://icons8.com/icon/On3brTbr5kbp/shopping-cart"></a></div>
                                <div><a href="{{ route('shoppingcart') }}"><img src="https://img.icons8.com/material-outlined/24/000000/shopping-cart--v2.png"/></a></div>
                        ...
                        <x-slot name="content">
                            <a href="/inventory" class="block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out">
                                {{ __('Inventaire') }}
                            </a>
                            <!-- Authentication -->
